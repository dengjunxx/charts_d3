...
import publicExtend from './publicExtend'
...
export default {
  render (h) {
    return h('div', {
      ...
      h('div', {
        style: this.canvasStyle,
        class: {'cbi-charts-mask-status': this.dataEmpty || this.loading},
        ref: 'canvas'
      }),
      h(DataEmpty, {
  ...
  methods: {
    ...
    optionsHandler (options) {
      ...
      //首先加载公共的配置项
      setExtend(options, publicExtend);
